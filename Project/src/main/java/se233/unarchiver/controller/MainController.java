    ...
    public void initialize ()
    {
        showPassword.setOnAction(e -> {
            if (showPassword.isSelected()) {
                passwordField.setText(hidePassword.getText());
                passwordField.setVisible(true);
                hidePassword.setVisible(false);
                return;
            } else {
                hidePassword.setText(passwordField.getText());
...
//        inputListView.getItems().addAll("Fundamentals", "Med Surg", "Pediatrics", "Oncology");
        ...
        {
            if (Objects.equals(hidePassword.getText(), "")) {
                hidePassword.setText(passwordField.getText());
            }else{
                passwordField.setText(hidePassword.getText());
            }
  ...
  //             commitArchive(e, inputListView);
            ...
            if (Objects.equals(hidePassword.getText(), "")) {
              ...
              if (Objects.equals(passwordField.getText(), "")) {
               ...
               if (Objects.equals(locationField.getText(), "")){
                ...
                checkLocation = locationField.getText();

                System.out.println("Name : " + checkName);
                System.out.println("Password : " + checkPassword);
                System.out.println("Location : " + checkLocation);
            ...
            String sumLocation = (checkLocation + "/" + checkName + ".zip");

            ZipFile zipFile = new ZipFile(sumLocation, checkPassword.toCharArray());
        ...
        browseField.setOnMouseClicked(e -> {
        ...
        extractbutton.setOnAction(e -> {
           ...
           // }
            ...
            String sumLocation = checkLocation + "/" + checkName ;
